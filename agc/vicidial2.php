			...
			if (xmlhttp) 
				...
				xmlhttp.onreadystatechange = function() 
					...
					//	alert(xmlhttp.responseText);
						...
						var loop_ct=0;
						var conv_start=0;
                        var CB_HTML = "<table width=\"100%\"><tr bgcolor=\"<?php echo $SCRIPT_COLOR ?>\"> <td align=\"center\"><font class=\"log_title\">LEAD ID</font></td><td align=\"center\"><font class=\"log_title\">VENDOR LEAD COD</font></td><td align=\"center\"><font class=\"log_title\">PHONE CODE</font></td><td align=\"center\"><font class=\"log_title\">PHONE NUMBER</font></td></tr>";
						...
						while (loop_ct < CB_calls)
                            ...
                            CB_HTML = CB_HTML + "<tr bgcolor=\"" + row_color + "\"> <td><font class=\"log_text_sm\">" + loop_ct + "</font></td><td align=\"right\"><font class=\"log_text_sm\">" + lead_id + "</td><td align=\"right\"><font class=\"log_text_sm\">" + vendor_lead_code + "</td><td align=\"right\"><font class=\"log_text_sm\">" + phone_code + "</font></td> <td align=\"right\"><font class=\"log_text_sm\">" + phone_number + "</font></td><td align=\"right\"><font class=\"log_text_sm\"><a href=\"#\" onclick=\"NeWManuaLDiaLCalLSubmiT('NOW'," + lead_id + "','" + vendor_lead_code + "','" + phone_code + "','" + phone_number + "');return false;\">DIAL</a>&nbsp;</font></td></tr>";
					...
					xmlhttprequestselectupdate.onreadystatechange = function() 
						...
						//	alert(xmlhttprequestselectupdate.responseText);
							...
							if (change_array[0] == '1')
								...
								document.getElementById("WebFormSpan").innerHTML = "<a href=\"" + TEMP_VDIC_web_form_address + "\" target=\"" + web_form_target + "\" onMouseOver=\"WebFormRefresH();\"><img src=\"./images/<?php echo _QXZ("vdc_LB_webform.gif"); ?>\" border=\"0\" alt=\"Map guide\" /></a>\n";
...
// Update vicidial_list lead record with all altered values from form
	...
	// ################################################################################
// ajaxfunction
function ajaxFunction(record_id,taskDSstage) {
    return $.ajax({
			  type: "GET",
			  url: "http://77.104.154.251/~amazonag/eyesee/crm/dgrid/check_record.php",
			  data: { id_record: record_id} 
			}).done(function(data){
				if(data == 1){
					DispoSelectContent_create('SALEAP',taskDSstage);
				}else{
					alert('The record id that you entered is not valid, find a valid CRM record id or choose another disposition');
				}
			});
}
var closerCampaing = 'PFCQO';
var closerID = 30;
var scheduledID = 31;
var scheduledCampaing = 'PFCQ';
...
// Generate the Call Disposition Chooser panel
	function DispoSelectContent_create(taskDSgrp,taskDSstage,DSCclick)
		{
			//code implementer by itcontinental
			//alert(TEMP_VDIC_web_form_address);
			var url = 'http://eyesee.internationalcallcentre.com/crm/dgrid/campaign_run.php?campaign_id=';
			switch(taskDSgrp){
				case  scheduledCampaing :
					url +=  scheduledID;
					window.open(url);
				break;
				case  closerCampaing :
		...
		if(taskDSgrp == 'SALE'){
			...
			$( "#dialog-confirm" ).dialog({
									  ...
									  buttons: {
										"Yes": function() {
											var record_id = prompt("Enter the CRM record id");
											ajaxFunction(record_id,taskDSstage);
										  $( this ).dialog( "close" );
										},
										"No": function() {
											window.open(TEMP_VDIC_web_form_address);
										  $( this ).dialog( "close" );
										}
									  }
								});
...
<span id="blind_monitor_notice_span"><b><font color="red"> &nbsp; &nbsp; <span id="blind_monitor_notice_span_contents"></span></font></b></span>
	...
	<div id="tabs">
	  <ul>
		<li><a href="#tabs-1">Sales Report</a></li>
		<li><a href="#tabs-2">Agent Report</a></li>
	  </ul>
	  <div id="tabs-1">
	  <?php //echo ": $VD_login on Phone: $SIP_user"; ?>
	   <iframe src="http://eyesee.internationalcallcentre.com/crm/customreports/detailed_report_agent.php?username=<?php echo $VD_login; ?>" width="<?php echo $MNwidth -130 ?>px" height="500px" ></iframe> 
	  </div>
	  <div id="tabs-2">
		<iframe src="../customreports/agent_report.php?user=<?php echo $VD_login; //echo ": $VD_login on Phone: $SIP_user"; ?>" width="<?php echo $MNwidth-130 ?>px" height="500px" ></iframe> 
	  </div>
	</div>
</span>
...
<div id="dialog-confirm" style="display:none;" title="Alert">
  <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Have you filled the webform?</p>
</div>
<script>
	function openColorBoxUrl(url){
			url = url + '&first_name='+document.vicidial_form.first_name.value+'&last_name='+document.vicidial_form.last_name.value+'&title='+document.vicidial_form.title.value+'&address1='+document.vicidial_form.address1.value+'&address2='+document.vicidial_form.address2.value+'&address3='+document.vicidial_form.address3.value+'&email='+document.vicidial_form.email.value;
			$.colorbox({href:url, data:{test: 'test'}, iframe:true, width:"90%", height:"90%"});
	}
